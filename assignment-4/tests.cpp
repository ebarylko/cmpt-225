...
TEST_CASE("find_smallest_child") {
    ...
    SUBCASE("Heap element with invalid child") {
        GIVEN("Heap element with no valid children") {
            vector<int> coll{-58, -31, -28, 82, -15, 50, -12, -25};
            WHEN("Calling the function") {
                THEN("Smallest child has an index of 7") {
                    REQUIRE(4 == find_smallest_child(coll, 3));
                }
            }
        }
    }
...
//     //     }
//     // }
//     // SUBCASE("Removing from a heap with random elements") {
//     //     GIVEN("An heap with many elements") {
//     //         Heap<int> heap;
//     //         vector<int> coll{-91, -71, -65, -31, -58, 50, -28, -25, 82, -12, -15};
//     //         priority_queue_sort(coll);
//     //         heap.insert_n({-91, -71, -65, -31, -58, 50, -28, -25, 82, -12, -15});
//     //         WHEN("Calling the function") {
//     //             vector<int> actual;
//     //             while (!heap.is_empty()) {
//     //                actual.push_back(heap.min());
//     //                heap.remove_min();
//     //             }
//     //             THEN("The heap order is maintained") {
//     //                 vector<int> expected = mk_vec({2, 3, 4, 5, 6, 15, 8, 11, 9});
...
//     //         vector<int> coll = rand_vec(100, -199, 100);
//     //         WHEN("Sorting the collection") {
//     //             vector<int> expected{coll};
//     //             sort(expected.begin(), expected.end());
//     //             priority_queue_sort(coll);
